...
:::tip TUTORIAL
If first discover, I highly recommend to go through the [tutorial](tutorial.md) for step-by-step Vtec Admin showcase using a fake API server.
:::
...
Use [Vetur](https://marketplace.visualstudio.com/items?itemName=octref.vetur) or any Jetbrains products for best development experience. All VA tag and attributes components are fully documented in a way to allow intellisense support !
:::
