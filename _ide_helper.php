 ...
 * Generated for Laravel 7.2.2 on 2020-03-22 10:31:42.
 *
...
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Author[]|Author create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Author[]|Author make($attributes = [])
    */
    class AuthorFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Book[]|Book create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Book[]|Book make($attributes = [])
    */
    class BookFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Publisher[]|Publisher create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Publisher[]|Publisher make($attributes = [])
    */
    class PublisherFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Review[]|Review create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Review[]|Review make($attributes = [])
    */
    class ReviewFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
