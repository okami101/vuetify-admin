...
For localized number and date field resource values, you will probably use the [`DateField`](components/fields#date-field) and the [`NumberField`](components/fields.md#number-field). This components will use specific Vue I18n functions under the hood :
