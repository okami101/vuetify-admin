...
#### 1. Describe backend resources you want to administer
...
#### 2. Instanciate Vtec Admin with those resources
...
#### 3. Finally define your CRUD pages for each resource

> This pages can be pre-generated by code generators. See [dedicated section](guide/generators).
